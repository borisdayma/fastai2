...
__all__ = ['WandbCallback', 'log_dataset', 'wandb_process']
...
class WandbCallback(Callback):
    ...
    def __init__(self, log="gradients", log_preds=True, log_dataset=False, dataset_name=None, valid_dl=None, n_preds=36, seed=12345):
